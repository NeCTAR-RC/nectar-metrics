...
entry_points = {
    ...
    'ceilometer.poll.central': [
        ...
        'nectar.application_catalog = nectar_metrics.ceilometer.application_catalog.pollster:EnvironmentPollster',  # noqa
    ...
    'ceilometer.discover.central': [
        ...
        'application_catalog = nectar_metrics.ceilometer.application_catalog.discovery:EnvironmentDiscovery',  # noqa
