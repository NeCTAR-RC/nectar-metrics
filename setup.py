...
entry_points = {
    ...
    'ceilometer.poll.central': [
        ...
        'nectar.orchestration = nectar_metrics.ceilometer.orchestration.pollster:HeatPollster', # noqa
    ...
    'ceilometer.discover.central': [
        ...
        'orchestration = nectar_metrics.ceilometer.orchestration.discovery:HeatDiscovery', # noqa
