...
def generate_gnocchi_instances(upload_swift=False):
    ...
    if upload_swift:
        _upload_swift(filename='gnocchi_resource_list_restricted.pkl')
        print("Uploaded gnocchi_resource_list_restricted.pkl")
        _upload_swift(filename='gnocchi_resource_list_restricted.json')
        print("Uploaded gnocchi_resource_list_restricted.json")
