...
class AccountPollster(plugin_base.PollsterBase):
    """ Collect stats on Nectar acccounts
    """

    def __init__(self, conf):
        super(AccountPollster, self).__init__(conf)
    ...
    def _make_sample(self, metric, value, resource_id, unit='Users'):
